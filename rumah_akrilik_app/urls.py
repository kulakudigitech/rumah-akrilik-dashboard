...
urlpatterns = [
    ...
    path('hrd/users/<int:user_id>/role/', hrd_update_user_role, name='hrd_update_user_role'),
    path('hrd/departments/', department_list_create, name='department-list-create'),
    path('hrd/departments/<int:pk>/', department_detail, name='department-detail'),
    path('hrd/departments/<int:pk>/users/', department_users, name='department-users'),
    path('hrd/dashboard/', hrd_dashboard_data, name='hrd-dashboard-data'),
