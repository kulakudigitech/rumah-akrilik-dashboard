...
const ProductionOrderDetail = () => {
  ...
  // Tambahkan state untuk daftar staff
  ...
  // Tambahkan useEffect untuk fetch daftar staff
  useEffect(() => {
    const fetchStaff = async () => {
      try {
        const token = localStorage.getItem('jwtToken');
        const response = await axios.get('https://rumahakrilik.id/api/users/?role=staff', {
